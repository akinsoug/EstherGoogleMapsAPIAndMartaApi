...
import com.tts.TransitApp.model.Geocoding;
...
public class TransitService {
	...
	private Location getCoordinates(String description) {
		...
		Geocoding geoList = response.results.get(0);
	...
	public Location getPersonCoordinates(BusRequest req ) {
		Location personLocation = this.getCoordinates(req.address + " " + req.city);
